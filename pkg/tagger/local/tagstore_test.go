...
func TestSubscribe(t *testing.T) {
	...
	var expectedEvents = []entityEventExpectation{
		{collectors.EventTypeAdded, "test1", []string{"low"}, []string{}, []string{"high"}},
		{collectors.EventTypeModified, "test1", []string{"low"}, []string{"orch"}, []string{"high:1", "high:2"}},
		{collectors.EventTypeAdded, "test2", []string{"low"}, []string{}, []string{"high"}},
		{collectors.EventTypeModified, "test1", []string{"low"}, []string{}, []string{"high"}},
		{collectors.EventTypeDeleted, "test1", nil, nil, nil},
	}
	...
	highCardEvents := []collectors.EntityEvent{}
	lowCardEvents := []collectors.EntityEvent{}
...
func collectEvents(wg *sync.WaitGroup, events *[]collectors.EntityEvent, ch chan []collectors.EntityEvent) {
...
func checkEvents(t *testing.T, expectations []entityEventExpectation, events []collectors.EntityEvent, cardinality collectors.TagCardinality) {
